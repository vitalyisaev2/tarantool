...
format[2] = {name='data', type='num'}
box.space.test1:format(format)
for i = 1, 10 do
    box.space.test1:insert({i, i})
end
...
box.space.test2:create_index('primary', {parts={1, 'NUM', 2, 'STR'}, type='TREE'})
format = {}
format[1] = {name='id', type='num'}
...
box.space.test4:create_index('secondary', {unique=false, parts={2, 'STR'}, type='TREE'})
